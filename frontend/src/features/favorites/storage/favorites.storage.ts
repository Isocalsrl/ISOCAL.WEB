import { createPersistedProductIdsStorage } from "../../../shared/storage/persistedProductIds";
import { FAVORITES_STORAGE_KEY, FAVORITES_STORAGE_VERSION } from "../constants/favorites.constants";
