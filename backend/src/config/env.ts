...
export const env = {
    ...
    database: {
        host: optionalString(process.env.DATABASE_HOST) ?? "127.0.0.1",
        port: positiveInteger(process.env.DATABASE_PORT, 5433),
        user: requiredString(process.env.DATABASE_USER, "DATABASE_USER"),
        password: requiredString(process.env.DATABASE_PASSWORD, "DATABASE_PASSWORD"),
        name: requiredString(process.env.DATABASE_NAME, "DATABASE_NAME"),
