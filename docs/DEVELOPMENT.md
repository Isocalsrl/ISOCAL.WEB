...
`npm run dev` valida el entorno, prepara PostgreSQL, aplica migraciones, ejecuta seeds y levanta backend + frontend.
...
Para reconstruir únicamente PostgreSQL de desarrollo:
