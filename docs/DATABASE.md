...
ISOCAL usa MariaDB/MySQL. En desarrollo Docker publica el servicio en `localhost:3307` para evitar conflictos frecuentes con instalaciones locales en `3306`.
...
`db:reset` reinicia el volumen MariaDB/MySQL local, pero conserva el almacenamiento persistente de archivos.
